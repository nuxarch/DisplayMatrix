...
RGBmatrixPanel matrix(DISP_A, DISP_B, DISP_C, DISP_D, CLK, LAT, OE, false, 32);
...
P10_MatrixLed::P10_MatrixLed(/* args */)
{
}

P10_MatrixLed::~P10_MatrixLed()
{
}

extern P10_MatrixLed matDisplay;